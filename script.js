for (var item of document.querySelectorAll(".numPadBtn")) {
    item.addEventListener("mousedown", function (evt) {
        evt.target.classList.add("numPadOnClick");
    }, false);
}

document.getElementById('clear').addEventListener("mousedown", function () {
    document.querySelector(".numPadBtn").classList.add("numPadOnClick");
});

document.addEventListener("mouseup", function () {
    for (var item of document.querySelectorAll(".numPadBtn")) {
        item.classList.remove("numPadOnClick");
    }
    document.querySelector(".numPadBtn").classList.remove("numPadOnClick");
});
